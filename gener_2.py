...
# pre_rendered_customer_names = [fake.name() for _ in range(250)]
# pre_rendered_courier_names = [fake.name() for _ in range(90)]  # 3 deliveries * 30 couriers each
#
# # Generate unique customer IDs
# unique_customers = 50000
# customer_ids = [f'CUST{str(i).zfill(5)}' for i in range(1, unique_customers + 1)]
#
# # Generate order IDs
...
# courier_ids = [f'CR{str(i).zfill(3)}' for i in range(1, 91)]  # 30 couriers per delivery, 3 deliveries
#
# order_counter = 0
...
#     customer_full_name = pre_rendered_customer_names[order_counter % 250]
#
...
#
#     courier_id = courier_ids[(order_counter // 3) % 90]  # Assign courier_id cyclically
#     courier_full_name = pre_rendered_courier_names[(order_counter // 3) % 90]
#
...
# new_file_path = 'pizzaplace_new.csv'
